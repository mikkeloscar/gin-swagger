...
func templatesApiGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/api.gotmpl", size: 7380, mode: os.FileMode(420), modTime: time.Unix(1535462514, 0)}
...
func templatesConfigGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/config.gotmpl", size: 1744, mode: os.FileMode(420), modTime: time.Unix(1535462174, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesParameterGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/parameter.gotmpl", size: 17430, mode: os.FileMode(420), modTime: time.Unix(1535462174, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
