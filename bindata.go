...
func templatesApiGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/api.gotmpl", size: 6383, mode: os.FileMode(420), modTime: time.Unix(1524124288, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesParameterGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/parameter.gotmpl", size: 17418, mode: os.FileMode(420), modTime: time.Unix(1524124288, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
